...
lol_2way_table_raw <- table(lol_MFonly$gender,
                            lol_MFonly$lane)
lol_2way_table <- addmargins(lol_2way_table)
lol_2way_table
```
...
> Question: What proportion of champions are female?

> Question: If gender and lane had no relationship, what percent of female champions should we expect to supports? Moreso, how many of the 34 supports would then be female?
