---
title: Collegiate Rowing Team Test Piece Ergometer Data for the Winter Training Period
author: Keelin Joyce
date: April 6, 2026
...
| `Date` | Date when the piece was completed. |
...
| `ID` | Number indicating individual (consistent between 2k and 6k, not between both). |
| `Piece` | Distance of the piece (2k or 6k) and type of piece (SS for steady state and test for a test piece). |

: [erg_df.csv](erg_df.csv){target="_blank"}


## Questions

1.    Do more men or women complete their 2k goal?
...
4.    Is there a relationship between the rate a 6k is rowed at and how fast the resulting time was?
