...
1.  Download this [csv file](8TH-WORLD-KUNGFU.csv). This is the result form parsing the 8th World Kung Fu Championship's Result Book.
2.  Using the [8th World Kungfu Championships,  2019 Clean Data set](kungfu_8.csv) as guiding north star, the techniques listed in this module and Subi Regex as a tool, challenge yourself to clean up the data set.
