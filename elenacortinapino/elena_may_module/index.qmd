...
2.  Using the [7th World Kungfu Championships,  2017 Clean Data set](kungfu_7.csv) as guiding north star, the techniques listed in this module and Subi Regex as a tool, challenge yourself to clean up the data set.
